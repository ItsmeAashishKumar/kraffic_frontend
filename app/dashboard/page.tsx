  ...
  setTimeout(capture, config.delay);
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            ...
            const msg = err.response?.data?.message || err.message || "Failed to delete website";
            toast.error(msg, { id: toastId });
        }
    };
                            ...
                            >
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 text-sm font-medium transition ${site.isActive ? "text-green-600" : "text-gray-400"
                                            }`}
                                    >
                                        {site.isActive ? (
